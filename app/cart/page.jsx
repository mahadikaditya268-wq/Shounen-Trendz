                ...
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId} className="border-b border-[var(--border)]/60">
                      ...
                      <td className="py-4 md:px-4 px-1 text-[var(--text-secondary)]">{currency}{product.offerPrice}</td>
                      ...
                      <td className="py-4 md:px-4 px-1 text-[var(--text-secondary)] font-semibold">{currency}{(product.offerPrice * cartItems[itemId]).toFixed(2)}</td>
                    </tr>
                  );
                })}
              </tbody>
